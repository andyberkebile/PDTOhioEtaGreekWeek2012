...
using CloudJourney.Framework.MathHelpers;
...
namespace CloudJourney.Framework.Rendering
{
    ...
    static public class Drawer
    {
        ...
        {
            FullScreenRectangle = new Rectangle(0, 0, Cloud.screenWidth, Cloud.screenHeight);
        ...
        {
            return Cloud.graphics.Viewport.Width / Cloud.screenWidth;
        }
        ...
        public static void DrawLine(Vector2 pointA, Vector2 pointB, float width, float layerDepth, Color color)
        {
            ...
            // around the vertical due to the 0-2pi singularity of the Vector2ToAngle funciton.
